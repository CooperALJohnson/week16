...
//formatter:off
  String sql = ""
     + "INSERT INTO orders ("
     + "customer_fk, color_fk, engine_fk, tire_fk, model_fk, price_fk"
     + ") VALUES ("
     + ":customer_fk, :color_fk, :engine_fk, :tire_fk, :model_fk, :price_fk"
     + ")";
//formatter:on
  ...
  params.source.addValue("color_fk", color.getColor());
  ...
  return jdbcTemplate.query(sql, params, new RowMapper<Option>() {
    ...
    public Option mapRow(ResultSet rs, int rowNum) throws SQLException{
      ...
      return Option.builder()
          .category(OptionType.valueOf(rs.getString("catagory")))
...
class ModelResultSetExtractor implements ResultSetExtractor<Jeep> {
  ...
  public Jeep extractData(ResultSet rs)
    ...
    return Jeep.builder()
        ...
        .wheelSize(rs.getInt("whele_size"))
